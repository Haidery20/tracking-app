                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="hero-title text-4xl tracking-tight sm:text-5xl md:text-6xl">
                            <span class="block text-primary">Digital Solutions</span>
                        ...
                        <p class="hero-subtitle mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            Discover our comprehensive digital services designed to help your business grow and succeed online.
                        </p>
                    </div>
                </main>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="space-y-12">
                <!-- Web Hosting -->
                <div class="relative bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-duration="1000">
                    <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                        <div class="lg:col-start-1 mb-8 lg:mb-0">
                            <img src="https://images.unsplash.com/photo-1518791841217-8f162f1e1131?w=800&h=600&fit=crop" alt="Web Hosting" class="rounded-lg shadow-xl w-full h-auto">
                        </div>
                        <div class="lg:col-start-2 p-8">
                            <h2 class="text-3xl font-bold text-gray-900 mb-6">Web Hosting</h2>
                            <div class="space-y-6">
                ...
                <!-- Web Design -->
                <div class="relative bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                        <div class="lg:col-start-2 mb-8 lg:mb-0">
                            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop" alt="Web Design" class="rounded-lg shadow-xl w-full h-auto">
                        </div>
                        <div class="lg:col-start-1 p-8">
                            <h2 class="text-3xl font-bold text-gray-900 mb-6">Web Design</h2>
                            <div class="space-y-6">
                                <div class="flex items-start">
                                    <div class="flex-shrink-0">
                ...
                <!-- SMS Bulk -->
                <div class="relative bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                    <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                        <div class="lg:col-start-1 mb-8 lg:mb-0">
                            <img src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=800&h=600&fit=crop" alt="SMS Bulk" class="rounded-lg shadow-xl w-full h-auto">
                        </div>
                        <div class="lg:col-start-2 p-8">
                            <h2 class="text-3xl font-bold text-gray-900 mb-6">SMS Bulk</h2>
                            <div class="space-y-6">
                                <div class="flex items-start">
                                    <div class="flex-shrink-0">
